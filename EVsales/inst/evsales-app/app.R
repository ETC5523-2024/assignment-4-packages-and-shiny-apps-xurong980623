...
ui <- fluidPage(
  ...
  # Use a shinytheme for enhanced styling
  theme = shinytheme("flatly"),

  # App title with custom CSS for styling
  tags$head(
    tags$style(HTML("
      body {
      ...
      .selectize-input, .slider, .shiny-bound-input {
        border-radius: 8px;
  ...
  sidebarLayout(
    sidebarPanel(
      style = "background-color: #ECF0F1; border-radius: 10px; padding: 20px;",
